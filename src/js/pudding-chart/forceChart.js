      ...
      updateChart(i) {
        ...
        switch (i){
          ...
          case 1:
              ...
              fCircle.transition().duration(500).delay(0).attr('r', width*0.58/2.6).attr('cy', height/2)
              pCircle.transition().duration(500).delay(0).attr('r', width*0.42/2.6).attr('cy', height/2)
